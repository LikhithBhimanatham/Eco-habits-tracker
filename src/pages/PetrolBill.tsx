                ...
                <div className="flex flex-col items-center justify-center text-center py-8">
                  ...
                  {allBillsEntered ? (
                    <Link to="/bills-summary">
                      <Button className="bg-ecoEarth-dark hover:bg-ecoEarth text-white mb-2">
                  ...
                  {!allBillsEntered && (
                    <div className="mt-4 bg-amber-50 rounded-lg p-4 text-left max-w-md">
                      <h3 className="font-medium text-gray-900 mb-1">Next Steps</h3>
                      <p className="text-sm text-gray-600">
                        For a complete analysis of your consumption patterns and potential savings, add your water and electricity bills too.
                      </p>
                    </div>
                  )}
                </div>
