...
import { Droplet, Upload, CheckCircle2 } from "lucide-react";
        ...
        <div className="max-w-2xl mx-auto">
          <header className="mb-8">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Water Bill Scanner</h1>
            </div>
            <p className="text-gray-600 mt-2">Track your water consumption by scanning your bill</p>
          </header>
          ...
          {isSubmitted ? (
            ...
            <div className="flex flex-col items-center justify-center py-12">
              <div className="text-center mb-8">
                <h2 className="text-xl font-semibold text-gray-800 mb-3">Scan Your Water Bill</h2>
                <p className="text-gray-600 max-w-md mx-auto">
                  Position your water bill clearly in the camera frame for the best OCR results
                </p>
              </div>
